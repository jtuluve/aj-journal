  ...
  return (
    <div className="abJ">
      ...
      <div className="containerab">
        ...
        <div id="indexingSection" className="aboutx">
          <h2>Indexing</h2>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque sequi quae, obcaecati quasi atque consequuntur
            culpa dolore beatae. Repellat modi veniam magnam animi dolorem optio ipsum cum, commodi dignissimos
            exercitationem.</p>
        ...
        {/**Content for Peer reviewing Section */}
        <div id="peerSection" className="aboutx">
        ...
        {/**Content for licensing & copyright policy Section */}
        <div id="licenceSection" className="aboutx">
          <h2>licensing &amp; Copyright Policy</h2>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque sequi quae, obcaecati quasi atque consequuntur
            culpa dolore beatae. Repellat modi veniam magnam animi dolorem optio ipsum cum, commodi dignissimos
            exercitationem.</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque sequi quae, obcaecati quasi atque consequuntur
        ...
        {/**Content for AJIMS Research Section */}
        <div id="AJIMSRCSection" className="aboutx">
        ...
        <div id="disclaimerSection" className="aboutx">
          <h2>Disclaimer</h2>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque sequi quae, obcaecati quasi atque consequuntur
            culpa dolore beatae. Repellat modi veniam magnam animi dolorem optio ipsum cum, commodi dignissimos
            exercitationem.</p>
