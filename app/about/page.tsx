  ...
  return (
    <div>
        ...
        <div>
          ...
          <div id="aimSection" className="about">
            <h2>Aim &amp; Scope</h2>
            <p>Aim &amp; Scope.</p>
          </div>
        <div id="indexingSection" className="about">
          <h2>Indexing</h2>
          <p>Indexing.</p>
        </div>
          <div id="peerSection" className="about">
            <h2>Peer reviewing process</h2>
            <p>Peer reviewing process.</p>
          </div>
        <div id="licenceSection" className="about">
          <h2>Licencing &amp; Copyright Policy</h2>
          <p>Licencing &amp; Copyright Policy.</p>
        </div>
          <div id="AJIMSRCSection" className="about">
            <h2>AJIMS Research Center</h2>
            <p>About for AJIMS Research Center.</p>
          </div>
        <div id="disclaimerSection" className="about">
          <h2>Disclaimer</h2>
          <p>Disclaimer.</p>
        </div>
        </div>
